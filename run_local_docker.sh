...
# Script to build and run the Test Full Deploy 1772170610 MCP Server locally in Docker
...
IMAGE_NAME="test-full-deploy-1772170610-mcp-server"
CONTAINER_NAME="test-full-deploy-1772170610-mcp-local"
HOST_PORT=${PORT:-8000}
CONTAINER_PORT=${PORT:-8000}

echo -e "${BLUE}🚀 Building and running Test Full Deploy 1772170610 MCP Server...${NC}"
echo
...
if [ ! -f .env ]; then
    ...
    if [ -f .env.example ]; then
        ...
        cat > .env << EOF
# Test Full Deploy 1772170610 MCP Server Configuration
PORT=8000
STAGE=MAINNET
LOG_LEVEL=INFO
...
echo
echo -e "${GREEN}✅ Test Full Deploy 1772170610 MCP Server is running!${NC}"
echo
